...
<ArticlePart>
	Some time, we need to create svg sprite for optimize our html markup and keep all of icons in
	separate file. But here, we will have some problem, we can't dymanicly change a color on this svg
	that is in svg sprite.
</ArticlePart>
