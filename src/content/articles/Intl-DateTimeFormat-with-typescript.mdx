...
previewImage: /images/articles-images/Intl-DateTimeFormat-with-typescript-banner.webp
...
Overload 1 of 2, '(locales?: LocalesArgument, options?: DateTimeFormatOptions): DateTimeFormat', gave the following error.
Overload 2 of 2, '(locales?: string | string[], options?: DateTimeFormatOptions): DateTimeFormat', gave the following error.ts(2769)
